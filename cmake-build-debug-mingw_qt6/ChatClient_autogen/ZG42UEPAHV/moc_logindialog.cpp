...
template <> constexpr inline auto LoginDialog::qt_create_metaobjectdata<qt_meta_tag_ZN11LoginDialogE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'sltTcpStatus'
        QtMocHelpers::SlotData<void(const quint8 &)>(4, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::UChar, 5 },
        }}),
        // Slot 'sltAnimationFinished'
...
void LoginDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onBtnLoginClicked(); break;
        case 2: _t->sltTcpStatus((*reinterpret_cast< std::add_pointer_t<quint8>>(_a[1]))); break;
        case 3: _t->sltAnimationFinished(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (LoginDialog::*)()>(_a, &LoginDialog::signalRotate, 0))
            return;
    }
}
