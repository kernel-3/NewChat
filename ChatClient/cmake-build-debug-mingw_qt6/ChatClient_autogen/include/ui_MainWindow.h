...
public:
    ...
    void setupUi(QWidget *LoginWidget)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/resource/background/app.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
...
"}"));
        ...
        btnWinMenu->setFocusPolicy(Qt::FocusPolicy::NoFocus);
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/resource/common/ic_login_cfg.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        btnWinMin->setFocusPolicy(Qt::FocusPolicy::NoFocus);
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/resource/common/ic_min.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        btnWinClose->setFocusPolicy(Qt::FocusPolicy::NoFocus);
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/resource/common/ic_close_white.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        labelWeclcom->setAlignment(Qt::AlignmentFlag::AlignCenter);
...
"}"));
        ...
        labelUserHead->setAlignment(Qt::AlignmentFlag::AlignCenter);
        ...
        lineEditPasswd->setEchoMode(QLineEdit::EchoMode::Password);
        ...
        btnLogin->setFocusPolicy(Qt::FocusPolicy::NoFocus);
        ...
        btnWinMin_2->setFocusPolicy(Qt::FocusPolicy::NoFocus);
        ...
        btnWinClose_2->setFocusPolicy(Qt::FocusPolicy::NoFocus);
        ...
        formLayout->setWidget(0, QFormLayout::ItemRole::FieldRole, lineEditHostAddr);
        ...
        formLayout->setWidget(1, QFormLayout::ItemRole::FieldRole, lineEditHostMsgPort);
        ...
        formLayout->setWidget(2, QFormLayout::ItemRole::FieldRole, lineEditHostFilePort);
