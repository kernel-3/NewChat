...
#include "../../../../CustomWidget/headers/animationstackedwidget.h"
...
namespace {
struct qt_meta_tag_ZN22AnimationStackedWidgetE_t {};
} // unnamed namespace

template <> constexpr inline auto AnimationStackedWidget::qt_create_metaobjectdata<qt_meta_tag_ZN22AnimationStackedWidgetE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<AnimationStackedWidget, qt_meta_tag_ZN22AnimationStackedWidgetE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
Q_CONSTINIT const QMetaObject AnimationStackedWidget::staticMetaObject = { {
    ...
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN22AnimationStackedWidgetE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN22AnimationStackedWidgetE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN22AnimationStackedWidgetE_t>.metaTypes,
    nullptr
} };
...
void *AnimationStackedWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN22AnimationStackedWidgetE_t>.strings))
